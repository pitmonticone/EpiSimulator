...
The heterogeneous contact patterns among provincial sub-populations are governed by synthetic contact matrices [@Prem2017] whose components $C_{ij}^{L}$ represent the frequency of daily contacts that a given agent of age group $i$ has with any agent of age group $j$ in a given location $L \in$ {Home, School, Work, Other}.
